...
def add_transporter_varaints(reaction, add_charge_neutral = True, balance_charge = False, round_dp = False):
    ...
    if len(species_combinations) >1:
        ...
        for species in species_combinations:    #####change to species_combinations from species_combinations()
            ...
            new_reaction.model = reaction.model #ensure the copied reaction has the model attribute set correctly (EDUARD EDIT)
